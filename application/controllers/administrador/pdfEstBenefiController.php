...
class pdfEstBenefiController extends CI_Controller {
  ...
  public function index()
  {
    ...
    //$this->pdf->SetFillColor(200,200,200);
            ...
            $this->pdf->Cell(30);
            $this->pdf->Cell(120,10,utf8_decode('ESTUDIO PARA BENEFICIO'),0,0,'C');
            $this->pdf->Ln('20');
            ...
            foreach ($personalidad as $persona) {
              ...
              $this->pdf->MultiCell(0,5,utf8_decode('NOMBRE COMPLETO:           '.$persona->nombre),0,$J,false);
              $this->pdf->ln('2');
              //sobrenombre
              $this->pdf->SetFont('Arial', '', 12);
              $this->pdf->MultiCell(0,5,utf8_decode('SOBRENOMBRE:                    '.$persona->sobrenombre),0,$J,false);
              $this->pdf->ln('2');
              //edad
              $this->pdf->SetFont('Arial', '', 12);
              $this->pdf->MultiCell(0,5,utf8_decode('EDAD:                                      '.$persona->edad.' AÑOS'),0,$J,false);
              $this->pdf->ln('2');
              //delito
              $this->pdf->SetFont('Arial', '', 12);
              $this->pdf->MultiCell(0,5,utf8_decode('DELITO:                                   '.$persona->delito),0,$J,false);
              $this->pdf->ln('15');
              //Actitud de la entrevista
              $this->pdf->SetFont('Arial', 'B', 12);
              $this->pdf->MultiCell(0,5,utf8_decode('ACTITUD TOMADA ANTE LA ENTREVISTA:'),0,$J,false);
              $this->pdf->ln('3');
              $this->pdf->SetFont('Arial', '', 12);
              $this->pdf->MultiCell(0,5,utf8_decode($persona->actitudEntrev),0,$J,false);
              $this->pdf->ln('10');
              // Examen mental
              $this->pdf->SetFont('Arial', 'B', 12);
              ...
              $this->pdf->ln('3');
              $this->pdf->SetFont('Arial', '', 12);
              $this->pdf->MultiCell(0,5,utf8_decode($persona->examenMen),0,$J,false);
              $this->pdf->ln('10');
              // Pruebas aplicadas
              $this->pdf->SetFont('Arial', 'B', 12);
              ...
              $this->pdf->ln('3');
              $this->pdf->SetFont('Arial', '', 12);
              $this->pdf->MultiCell(0,5,utf8_decode($persona->pruebasApli),0,$J,false);
              $this->pdf->ln('10');
              // Nivel intelectual
              $this->pdf->SetFont('Arial', 'B', 12);
              ...
              $this->pdf->ln('3');
              $this->pdf->SetFont('Arial', '', 12);
              $this->pdf->MultiCell(0,5,utf8_decode($persona->nivelInte),0,$J,false);
              $this->pdf->ln('10');
              ...
              //Psicologo
              $this->pdf->SetFont('Arial', 'B', 10);
              $this->pdf->MultiCell(0,5,utf8_decode('             LIC. JAVIER ALVAREZ LEÓN                                          PSIC. ENEDELIA ROJAS PIZANO'),0,$J,false);
              $this->pdf->Cell(30);
              $this->pdf->Ln('2');
              //Cordinacion
              $this->pdf->SetFont('Arial', 'B', 10);
              $this->pdf->MultiCell(0,5,'               SUBDIRECTOR JURIDICO                                             COORD. DEPTO DE PSICOLOGIA',0,$J,false);
              $this->pdf->Cell(30);
              $this->pdf->Ln('2');
              //Encargado
              $this->pdf->SetFont('Arial', 'B', 10);
    ...
    $carpeta = 'C:/xampp/htdocs/cereso/Formatos/estudioparabeneficio/';
    $this->pdf->Output($carpeta.$nombrepdf.'.pdf','F');
     $this->pdf->Output("Estudio_para_beneficio_de_" . $nombrepdf . ".pdf", 'I');
